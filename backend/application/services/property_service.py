...
from domain.ports.property_repository import PropertyQueryRepository
...
class PropertyService:
    ...
    Depende de interfaces segregadas para evitar acoplamientos (ISP).
    """

    def __init__(
        self,
        property_repo: PropertyQueryRepository,
